...
import { getTeams, getTeam, createTeam, updateTeam, deleteTeam, getMembers, } from "../controllers/teamController.js";
...
teamRouter.post("/", validateAuthorization("admin"), validateData(teamCreateSchema), createTeam);
teamRouter.get("/", getTeams);
teamRouter.get("/:id", getTeam);
teamRouter.get("/:id/members", getMembers);
teamRouter.put("/:id", validateAuthorization("admin"), validateData(teamUpdateSchema), updateTeam);
